...
const TermsPage = ({ children }) => (
	<div>
		<Helmet>
			...
			<title>Terms & Conditions | Cashbac App</title>
			<html lang="en" />
			{/* Google / Search Engine Meta Tags */}
			<meta itemprop="name" content="PT. Global Pay Indonesia" />
			<meta
				itemprop="description"
				content="Learn more about the terms and conditions of Cashbac application including how to register, link your card, make transactions and earn cashback rewards"
			/>
