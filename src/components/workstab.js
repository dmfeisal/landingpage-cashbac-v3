	...
	<div>
		<section className="section has-background-light" id="works">
			...
			With our simple and easy-to-use app, you can now enjoy instant cashback anywhere and anytime
				...
				<div class="container">
					<article className="media" id="signup">
						...
						<article className="media" id="link-card">
						...
						<article className="media" id="explore">
							<div className="media-content">
								<div className="content">
									<figure className="media-top">
										<span className="is-medium">
						...
						<article className="media" id="pin">
						...
						<article className="media" id="tap">
						...
						<article className="media" id="cashback">
							<div className="media-content">
								<div className="content">
									<figure className="media-top">
										<span className="is-medium">
